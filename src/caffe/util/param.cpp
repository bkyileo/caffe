...
/*
  ...
  LOG(INFO) << "test_max_size        : " << rfcnParam::test_max_size; 
  LOG(INFO) << "test_nms             : " << rfcnParam::test_nms; 
  LOG(INFO) << "test_bbox_reg        : " << (rfcnParam::test_bbox_reg?"yes":"no");
  LOG(INFO) << "test_rpn_nms_thresh  : " << rfcnParam::test_rpn_nms_thresh;
  LOG(INFO) << "rpn_pre_nms_top_n    : " << rfcnParam::test_rpn_pre_nms_top_n;
  LOG(INFO) << "rpn_post_nms_top_n   : " << rfcnParam::test_rpn_post_nms_top_n;
  LOG(INFO) << "test_rpn_min_sizen   : " << rfcnParam::test_rpn_min_size; 
  ...
  LOG(INFO) << "rng_seed             : " << rfcnParam::rng_seed;
  LOG(INFO) << "eps                  : " << rfcnParam::eps; 
  LOG(INFO) << "inf                  : " << rfcnParam::inf; 
  LOG(INFO) << "feat_stride          : " << rfcnParam::feat_stride;
  LOG(INFO) << "anchors_size         : " << rfcnParam::anchors.size();
  LOG(INFO) << "test_score_thresh    : " << rfcnParam::test_score_thresh;
  LOG(INFO) << "n_classes            : " << rfcnParam::n_classes;
  LOG(INFO) << "iter_test            : " << rfcnParam::iter_test;
*/
}
} 
